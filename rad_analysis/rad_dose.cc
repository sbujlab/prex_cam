...
int main(Int_t argc,Char_t* argv[]) {
  ...
  for (int v=0 ; v <= n_files ; v++){ 
    ...
    if (v==0){
      temp_str_stream3<<"/home/cameronc/gitdir/prex_cam/build/prex_dump_"<<argv[1]<<"_"<<n_mills<<"M/prex_dump_"<<argv[1]<<"_1M.root";
    }
    else {
      temp_str_stream3<<"/home/cameronc/gitdir/prex_cam/build/prex_dump_"<<argv[1]<<"_"<<n_mills<<"M/prex_dump_"<<argv[1]<<"_1M_"<<vS<<".root";
    }
